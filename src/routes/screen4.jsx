      ...
      <main style={{ padding: "1rem 0" }}>
        ...
        <div className='text'>
          <body>
            ...
            <h2 className='title'><span style={{fontFamily: 'LGSMARTBOLD'}}>Quantum Leap 3: Dark Star</span>, 2022</h2>
            <p>
            ...
            <div className='product' style={{display: 'flex'}}>
              <img className='productImg' src={'https://www.lge.co.kr/kr/images/tvs/md09062827/gallery/medium06.jpg'} alt="artwork"  />
              <div>
                <h3>
